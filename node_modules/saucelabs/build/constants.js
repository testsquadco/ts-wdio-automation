...
const DEFAULT_SAUCE_CONNECT_VERSION = exports.DEFAULT_SAUCE_CONNECT_VERSION = '4.9.1';
const SAUCE_CONNECT_BASE = exports.SAUCE_CONNECT_BASE = 'https://saucelabs.com/downloads';
const SAUCE_CONNECT_VERSIONS_ENDPOINT = exports.SAUCE_CONNECT_VERSIONS_ENDPOINT = 'https://saucelabs.com/versions.json';
const SAUCE_CONNECT_PLATFORM_DATA = exports.SAUCE_CONNECT_PLATFORM_DATA = {
  darwin: {
...
const PROTOCOL_MAP = exports.PROTOCOL_MAP = protocolFlattened;
const PARAMETERS_MAP = exports.PARAMETERS_MAP = parametersFlattened;
const JOB_ASSET_NAMES = exports.JOB_ASSET_NAMES = ['console.json', 'performance.json', 'automator.log', 'selenium-server.log', 'log.json', 'logcat.log', 'video.mp4'];
...
const ASSET_REGION_MAPPING = exports.ASSET_REGION_MAPPING = {
  us: '',
  eu: 'eu-central-1.',
  'us-west-1': '',
  'us-east-4': 'us-east-4.',
...
const SYMBOL_INSPECT = exports.SYMBOL_INSPECT = Symbol.for('nodejs.util.inspect.custom');
const SYMBOL_TOSTRING = exports.SYMBOL_TOSTRING = Symbol.toStringTag;
const SYMBOL_ITERATOR = exports.SYMBOL_ITERATOR = Symbol.iterator;
const TO_STRING_TAG = exports.TO_STRING_TAG = 'SauceLabs API Client';
const USAGE = exports.USAGE = `Sauce Labs API CLI

Usage: sl <command> [options]`;
const EPILOG = exports.EPILOG = `Copyright ${new Date().getUTCFullYear()} © Sauce Labs`;
...
const SAUCE_CONNECT_CLI_PARAMS = exports.SAUCE_CONNECT_CLI_PARAMS = [{
  /**
   * custom parameter
   */
  name: 'sc-version',
...
const SC_BOOLEAN_CLI_PARAMS = exports.SC_BOOLEAN_CLI_PARAMS = SAUCE_CONNECT_CLI_PARAMS.filter(p => p.type === 'boolean').map(p => p.name);
const SAUCE_CONNECT_CLI_PARAM_ALIASES = SAUCE_CONNECT_CLI_PARAMS.map(param => param.alias).filter(Boolean);
const SC_CLI_PARAM_KEYS = exports.SC_CLI_PARAM_KEYS = SAUCE_CONNECT_CLI_PARAMS.map(param => param.name);
const SC_PARAMS_TO_STRIP = exports.SC_PARAMS_TO_STRIP = [...CLI_PARAM_KEYS, ...CLI_PARAM_ALIASES, ...SAUCE_CONNECT_CLI_PARAM_ALIASES];
const SC_READY_MESSAGE = exports.SC_READY_MESSAGE = 'Sauce Connect is up, you may start your tests';
const SC_FAILURE_MESSAGES = exports.SC_FAILURE_MESSAGES = ['Sauce Connect could not establish a connection', 'Sauce Connect failed to start'];
const SC_WAIT_FOR_MESSAGES = exports.SC_WAIT_FOR_MESSAGES = ['\u001b[K', 'Please wait for']; // "\u001b" = Escape character
const SC_CLOSE_MESSAGE = exports.SC_CLOSE_MESSAGE = 'Goodbye';
const SC_CLOSE_TIMEOUT = exports.SC_CLOSE_TIMEOUT = 5000;